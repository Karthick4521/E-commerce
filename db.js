  ...
  return {
    ...
    products: [
      ...
      },
      {
        ...
        description: 'Casual low-top canvas sneakers, everyday wear.',
        price: 34.99,
        stock: 50,
        image: '👞',
        category: 'Footwear',
      },
      {
        id: 8,
        name: 'Leather Boots',
        description: 'Ankle-height genuine leather boots, all-season.',
        price: 74.99,
        stock: 20,
        image: '🥾',
        category: 'Footwear',
      },
      {
        id: 9,
        name: 'Flip Flops',
        description: 'Lightweight foam flip flops, great for summer.',
        price: 9.99,
        stock: 80,
        image: '🩴',
        category: 'Footwear',
      },
      {
        ...
        description: 'Set of 4 ceramic mugs, dishwasher and microwave safe.',
        price: 24.99,
        stock: 35,
        image: '☕',
        category: 'Home',
      ...
      },
      {
        ...
        description: 'Set of 2 decorative throw pillows, machine washable covers.',
        price: 17.5,
        stock: 45,
        image: '🛋️',
        category: 'Home',
      ...
      },
      {
        id: 15,
        name: 'Wool Beanie',
        description: 'Soft knit wool beanie, one size fits most.',
        price: 14.99,
        stock: 55,
        image: '🧢',
        category: 'Accessories',
